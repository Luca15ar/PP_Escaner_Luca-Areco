namespace Entidades
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            bool pudo = l + l1;
            pudo = l + l2;
            pudo = l + l3;      //No debe entrar
            pudo = l + l4;      //No debe entrar
            pudo = l + l5;      //No debe entrar
            pudo = m + m1;
            pudo = m + m2;
            pudo = m + m3;
            pudo = m + m4;
            pudo = m + m5;      //No debe entrar
            pudo = m + m6;      //No debe entrar
            try
            {
                pudo = m + l1;  //No debe entrar
                pudo = l + m1;  //No debe entrar
            ...
            Console.WriteLine($"Cantidad de libros en el escáner: {cantidadLibroTerminado}.");
            Console.WriteLine($"Cantidad de páginas en el escáner: {extensionLibroTerminado}.");
